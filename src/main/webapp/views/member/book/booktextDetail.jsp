...
.replyBtns:hover {
   background-color: #e0e0e0;
    ...
    .detail-ele1 {
    display: flex;
    flex-wrap: wrap; /* 요소들이 공간에 맞게 줄 바꿈 가능 */
    gap: 2vw; /* 요소들 간의 간격 설정 (선택적) */
	}
	 .detail-ele2 {
    display: flex;
    flex-wrap: wrap; /* 요소들이 공간에 맞게 줄 바꿈 가능 */
          ...
          <div class ="detail-left">
           ...
           <div class="detail-right">
               		<div class="detail_section detail_image">
                    	<img id="detailImg" src="<%= detail.get("bk_img") %>" alt="책 이미지" width="250px">
                	</div>
              </div>
      </div>
